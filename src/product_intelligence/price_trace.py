...
class _SourceState:
    ...
    def apply(self, status: str, **payload: Any) -> None:
        ...
        if status == "RAW_RESULT_FOUND":
            self.raw_hit = True
        if status in {"URL_DISCOVERED", "FETCH_STARTED", "FETCH_OK", "FETCH_BLOCKED", "FETCH_TIMEOUT", "PARSER_STARTED", "PARSER_ZERO_OFFERS", "IDENTITY_ACCEPTED", "IDENTITY_REJECTED", "PRICE_NOT_FOUND", "PRICE_REJECTED", "OUT_OF_STOCK", "OFFER_ACCEPTED", "OFFER_DEDUPED"}:
            self.url_found = True
        if status in {"FETCH_STARTED", "FETCH_OK", "FETCH_BLOCKED", "FETCH_TIMEOUT", "PARSER_STARTED", "PARSER_ZERO_OFFERS", "IDENTITY_ACCEPTED", "IDENTITY_REJECTED", "PRICE_NOT_FOUND", "PRICE_REJECTED", "OUT_OF_STOCK", "OFFER_ACCEPTED", "OFFER_DEDUPED"}:
            self.fetched = True
